...
Public Class [!output SAFE_CLASS_NAME]
    ...
    'Private Sub ThisWorkbook_Open() Handles MyBase.Open
    '    OldCode.ThisWorkbook_Open()
    'End Sub

    'Private Sub ThisWorkbook_CloseEvent(ByRef Cancel as Boolean) Handles MyBase.BeforeCloseEvent
    '    OldCode.ThisWorkbook_Close()
    'End Sub
